...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "3.3.0"
  WORKING_DIRECTORY "/Users/JLoong8/git/MinION/source/build/_deps/seqan3_fetch_content-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/JLoong8/git/MinION/source/build/_deps/seqan3_fetch_content-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/JLoong8/git/MinION/source/build/_deps/seqan3_fetch_content-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
