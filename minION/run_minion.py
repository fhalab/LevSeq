...
def main(args, parallel = True):
    ...
    # ### ----- Demultiplex ----- ###    
    run_demultiplexer(result_folder, BARCODES, 50, 25)
    ...
    #                 futures.append(executor.submit(process_barcode, reverse, forward, ref_seq))
    ...
    #             # Run Consensus
    #             prompt = consensus_prompt(fastq_file, output_dir, ref_seq, n_threads = 2
    #                                       , model = "default")
    #             run_medaka(prompt)
    ...
    # ### ----- Variant Data Frame ----- ###
    # variant_df = get_variant_df(demultiplex_folder, ref_seq, sequences=True)
