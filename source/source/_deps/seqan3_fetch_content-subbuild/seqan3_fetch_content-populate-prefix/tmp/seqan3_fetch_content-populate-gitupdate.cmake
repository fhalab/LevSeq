...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "3.3.0"
  WORKING_DIRECTORY "/Users/JLoong8/git/MinION/source/source/_deps/seqan3_fetch_content-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/3.3.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "3.3.0")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/seqan/seqan3.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/JLoong8/git/MinION/source/source/_deps/seqan3_fetch_content-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/JLoong8/git/MinION/source/source/_deps/seqan3_fetch_content-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
